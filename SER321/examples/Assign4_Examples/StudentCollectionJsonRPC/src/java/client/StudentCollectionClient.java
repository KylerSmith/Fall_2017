...
import sample.student.server.StudentCollection;
import sample.student.server.StudentHttpProxy;
...
public class StudentCollectionClient extends Object {
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         StudentCollection sc = (StudentCollection)new StudentHttpProxy(new URL(url));
         BufferedReader stdin = new BufferedReader(
            new InputStreamReader(System.in));
         System.out.print("Enter end or {add|get|getById|getNames|remove} followed by args>");
         ...
         while(!opn.equalsIgnoreCase("end")) {
            if(opn.equalsIgnoreCase("add")){
               ...
               System.out.print("The collection has entries for the following students: ");
